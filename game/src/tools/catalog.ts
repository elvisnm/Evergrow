...
export const TOOLS: readonly Tool[] = [
  ...
  {id:'difficulty',group:'data',name:'World difficulty',path:'/progression.html?view=difficulty',description:'Procedural difficulty badges, live selector and level-50 monster scaling. Disposable preview only.'},
